...
// }
// $consulta = "SELECT * FROM empleados WHERE correo = '$usuario'";
...
$query = $conexion->prepare("SELECT idmascota, nombre, color, genero, raza, especie, peso, edad, fecha FROM mascotas");
$query->execute();
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-first">
            ...
            <ul class="navbar-nav space-buttons">
              <li class="nav-item dropdown">
                ...
                <ul class=" dropdown-menu " aria-labelledby="navbarDarkDropdownMenuLink">
                  ...
                  <li><a class="dropdown-item" href="../PhpAndHtml/consultas.php">Consultas</a></li>
                  ...
                  <div class="modal-body">
                    <form class="row g-3" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="number" step="any" name="peso" class="form-control" min="0" max="120" id="inputPeso" placeholder="20.5">
                      </div>
                      <div class="col-md-6">
                        <label for="inputEdadM" class="form-label">Edad en años</label>
                        <input type="number" step="any" name="edad" class="form-control" min="0" max="20" id="inputEdadM" placeholder="5">
                      </div>
                      <div class="col-12">
                ...
                <div class="modal-content">
                  ...
                  <?php foreach($resultado as $mascotas) : ?>
                    <form class="row g-3" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" enctype="multipart/form-data">
                      <div class="col-12">
                        <label for="inputNombre" class="form-label">Nombre</label>
                        <input type="text" name="nombre" class="form-control" id="inputNombreM" value="$consulta">
                      </div>
                      <div class="col-12">
                        <label for="inputColor" class="form-label">Color</label>
                        <input type="text" name="color" class="form-control" id="inputColor" placeholder="Negro">
      ...
      <div class="main">
        ...
        <table class="default">      
          ...
          <td><?php echo $mascotas['genero']?></td>
          <td><?php echo $mascotas['raza']?></td>
          <td><?php echo $mascotas['especie']?></td>
          <td><?php echo $mascotas['peso']?></td>
          <td><?php echo $mascotas['edad']?></td>
          <td><?php echo $mascotas['fecha']?></td>
          <td class="especial"><a type="button" class="btn btn-outline-danger" href="editar.php?id=<?php echo $mascotas['idmascota']?>" class="table__item__link" >Editar</a></td>
          <!-- <td class="especial" data-bs-toggle="modal" data-bs-target="#Modaleditar"><a href="editar.php?id=<?php echo $mascotas['idmascota']?>">Editar</a> -->
          <td class="especial"><a type="button" class="btn btn-outline-danger" href="eliminarReg.php?id=<?php echo $mascotas['idmascota']?>" class="table__item__link" ><span class="material-icons" >
          delete
          </span></a></td>
