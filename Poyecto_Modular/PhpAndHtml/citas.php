...
<nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-first">
  <div class="container-fluid">
      ...
      <ul class="navbar-nav space-buttons">
        <li class="nav-item dropdown">
          ...
          <ul class=" dropdown-menu " aria-labelledby="navbarDarkDropdownMenuLink">
            ...
            <li><a class="dropdown-item" href="../PhpAndHtml/index.php">Pacientes</a></li>
    ...
    <!-- <div class="collapse navbar-collapse space-buttons" id="navbarSupportedContent">
      ...
      <div class="collapse navbar-collapse space-buttons" id="navbarSupportedContent">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Modalmascota" title="Agregar paciente">
          <span class="material-icons">
            pets
            </span>
        </button>
